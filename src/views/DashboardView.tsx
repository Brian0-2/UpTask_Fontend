...
export default function DashboardView() {
  ...
  // useQuery obtiene los datos
  const {
    data,
    // error, retorna el proque del error
    // isError, retorna true o false si hay algun error
    isLoading,
  } = useQuery({
    //Query key me aseguro que estoy modificando la consulta de los projectos como un estado
    queryKey: ["projects"],
    queryFn: getProjects,
  });
